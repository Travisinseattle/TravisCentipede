...
//        ship.add(new Components.HitBox());
    ...
    /**
     * Method that creates a centipede segment entity that will spawn
     * on the screen. Entity is comprised of components that
     * control behavior. Segments follow the lead segment.
     *
     * @param theGameView is a reference to the game view.
     * @param x is the x position of the segment.
     * @param y is the y position of the segment.
     * @param theParent is the UUID of the parent node for this segment.
     * @return A MetaEntity object of the centipede body.
     */
