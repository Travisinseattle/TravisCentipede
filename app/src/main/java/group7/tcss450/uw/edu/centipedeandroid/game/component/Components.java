...
//    }
    ...
    public static class Direction implements Component {
        ...
        /** method that swaps the current directiuon of the centipede
         *
         * @param theDir is the direction to be swapped.
         */
    ...
    public static class CentipedeID implements Component {
        ...
        /** Array of UUIDS of the segments */
        private UUID[] mIDs;

        /** The parent UUID to control others */
        private UUID mHead;
    ...
    /**
     * Method component that can split a centipede into two centipedes and put the correct segment UUIDS
     * back into the newly created centipede.
     *
     * @param theIDS of segments that will be split
     * @param theSeg that is being deleted from the list of UUID's
     */
